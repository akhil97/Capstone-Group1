...
def adjust_coordinates_and_create_tuples(xs, ys):
    # Approximate step size for 100 meters at the equator
    # By multiplying this step size by 10, the function effectively shifts each longitude coordinate westward by
    # approximately 1000 meters and each latitude coordinate northward by approximately 1000 meters.
    xs_adjusted = [x - 10 * 0.00083333333 for x in xs]
    ys_adjusted = [y + 10 * 0.00083333333 for y in ys]
...
if __name__ == '__main__':
    base_dir = '/home/ubuntu/Cap2024/context/resampled_data11'
