...
if __name__ == '__main__':
    ...
    processor = TIFFProcessor(gpkg_path, tif_directory, output_dir)
    ...
    concatenator = CSVConcatenator(input_dir, output_file)
    ...
    merger = CSVMerger(covariate_file, merged_contextual_feature_file, bgrn_file, output_file)
